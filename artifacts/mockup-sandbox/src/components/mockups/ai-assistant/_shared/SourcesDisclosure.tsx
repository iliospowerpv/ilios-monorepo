...
interface SourcesDisclosureProps {
  ...
  // Sandbox-only: lets a static preview show the expanded state (the app default is collapsed).
  defaultOpen?: boolean;
}
...
export const SourcesDisclosure: React.FC<SourcesDisclosureProps> = ({ sources, defaultOpen = false }) => {
