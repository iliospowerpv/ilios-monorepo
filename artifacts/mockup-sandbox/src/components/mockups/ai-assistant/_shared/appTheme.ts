// Verbatim copy of the iliOS main-app MUI theme
// (frontend/rea-investment-fe/src/utils/styles/theme.ts) so the real AI Assistant
// components render with the exact app palette, gradients, and component overrides.
