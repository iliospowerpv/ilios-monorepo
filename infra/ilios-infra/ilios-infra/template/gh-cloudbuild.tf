...
resource "google_project_iam_member" "default_sa_secret_manager_accessor" {
  project = "prj-secret-22f2"
...
resource "google_secret_manager_secret_iam_policy" "policy" {
  ...
  secret_id = "projects/prj-secret-22f2/secrets/GH-Token"
...
resource "google_cloudbuildv2_connection" "my_connection" {
    ...
    github_config {
        ...
        authorizer_credential {
            oauth_token_secret_version = "projects/prj-secret-22f2/secrets/GH-Token/versions/latest"
        }
    }
