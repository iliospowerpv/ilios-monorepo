  ...
  ({ mode, setMode, siteId, data, reflectFormState, portfolioId }, ref) => {
    ...
    const handleEntityChange = React.useCallback(
      (_entityId: number | null, entity?: ProjectEntity | null) => {
        ...
        setValue('om_contact_name', null, { shouldDirty: true });
        setValue('om_contact_email', null, { shouldDirty: true });
        setValue('om_contact_phone', null, { shouldDirty: true });
        if (entity) {
    ...
    const handleContactChange = React.useCallback(
      (_contactId: number | null, contact: Contact | null) => {
        ...
        if (contact) {
          ...
          setValue('om_contact_name', fullName || null, { shouldDirty: true });
          setValue('om_contact_email', contact.email || null, { shouldDirty: true });
          setValue('om_contact_phone', contact.phone || null, { shouldDirty: true });
        }
      },
      [setValue]
    );
