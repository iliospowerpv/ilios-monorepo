...
// Promotion error mapping now lives in the shared promotion module so the
// Reconciliation and Data Room launchers share one implementation. Re-exported
// from the leaf file (not the barrel) so importing it here never pulls the MUI
// dialog into this widely-imported utils module.
export { promotionErrorMessage } from '../../../../../../components/promotion/promotionErrorMessage';
