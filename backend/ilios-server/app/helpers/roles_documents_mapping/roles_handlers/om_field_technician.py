...
from app.static.roles_documents_mapping.om_field_technician import (
    document_name_section_mapper,
    document_sub_sections_mapper,
)


class OMFieldTechnicianDocuments(RoleBasedDocumentConfig):

    def __init__(self):
        super().__init__(
            document_sub_sections_mapper=document_sub_sections_mapper,
            document_name_section_mapper=document_name_section_mapper,
            role_name=InternalRolesNames.om_field_technician,
        )
