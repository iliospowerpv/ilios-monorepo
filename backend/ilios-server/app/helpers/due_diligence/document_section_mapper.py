...
document_sub_sections_mapper = {
    ...
    DocumentSections.stage2: [
        ...
        DocumentSections.tax_equity_funding_stage2,
    ],
...
document_name_section_mapper = {
    ...
    DocumentSections.preview: [
        ...
        SiteDocumentsEnum.cra_community_reinvestment_act,
        SiteDocumentsEnum.nmtc_new_market_tax_credit,
        SiteDocumentsEnum.fema_disaster_declaration_yn,
        SiteDocumentsEnum.esg_statement_enviromental_social_governance,
        SiteDocumentsEnum.epa_greenhouse_gas_equivalencies_calculator,
        SiteDocumentsEnum.usda_reap,
    ...
    DocumentSections.projectco_lessor: [
        ...
        SiteDocumentsEnum.financial_projections_project_life,
    ...
    DocumentSections.projectco_lessor_parent: [
        ...
        SiteDocumentsEnum.employer_identification_number_w9_or_irs_letter,
        SiteDocumentsEnum.operating_agreement_including_all_amendments,
        SiteDocumentsEnum.proof_of_projectco_ownership_pmipa_parent_mipa,
        SiteDocumentsEnum.certificate_of_good_standing,
        SiteDocumentsEnum.incumbency_certificate_resolutions_proof_of_authority,
        SiteDocumentsEnum.ucc_tax_bankruptcy_judgment_and_pending_litigation_searches,
    ...
    DocumentSections.substantial_completion_stage2: [
        ...
        SiteDocumentsEnum.seller_acceptance_of_second_buyer_pv_syst_report,
        SiteDocumentsEnum.seller_independent_pv_syst_report,
        SiteDocumentsEnum.final_pv_syst_reports_average,
