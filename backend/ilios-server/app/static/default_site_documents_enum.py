...
class DocumentSections(enum.Enum):
    ...
    managing_member_of_lessee_holdco_sponsor_parent = "Managing Member of Lessee HoldCo (Sponsor) & Parent"
...
class SiteDocumentsEnum(enum.Enum):
    ...
    preliminary_drawings_for_model_electronics = "Preliminary Drawings for Model - Electrical"
    preliminary_drawings_for_model_civil = "Preliminary Drawings for Model - Civil"
    seller_initial_pv_syst_full_data_package_for_model = "PV Syst - Initial Package for Modeling - Seller"
    ...
    esg_statement_enviromental_social_governance = "ESG Statement (Environmental, Social & Governance)"
    epa_greenhouse_gas_equivalencies_calculator = "EPA Greenhouse Gas Equivalencies Calculator"
    usda_reap = "USDA / REAP"
    ferc_556 = "FERC 556"
    ...
    leasehold_area_metes_and_bounds_legal_description = "Leasehold Area Metes and Bounds Legal Description"
    purchase_option = "Purchase Option"
    evidence_of_application_for_municipal_permits = "Evidence of Application for Municipal Permits"
    ...
    usfws_concurrence_letter_re_protected_species = (
        "USFWS Concurrence Letter re. protected species, & any associated correspondence"
    )
    site_assessment = "Site Assessment"
    geotechnical_report = "GeoTechnical Report"
    alta_survey = "ALTA Survey"
    faa_obstruction_evaluation_airport_airspace_analysis = "FAA Obstruction Evaluation / Airport Airspace Analysis"
    assignment_of_site_lease_to_projectco_lessor = "Assignment of Site Lease to ProjectCo (Lessor)"
    recorded_memorandum_of_site_lease_assignments = "Recorded Memorandum of Site Lease & Assignments"
    site_lease_estoppel_for_benefit_of_investor = "Site Lease Estoppel for Benefit of Investor"
    ...
    bond_rating_or_other_third_party_financial_review = "Bond Rating or other Third Party Financial Review"
    ...
    proof_of_projectco_ownership_amipa_acquisition_mipa = "Proof of ProjectCo Ownership (AMIPA Acquisition MIPA)"
    # common - certificate_of_good_standing
    # common - incumbency_certificate_resolutions_proof_of_authority
    # common - ucc_tax_bankruptcy_judgment_and_pending_litigation_searches
    ...
    proof_of_projectco_ownership_pmipa_parent_mipa = "Proof of ProjectCo Ownership (PMIPA Parent MIPA)"
    # common - certificate_of_good_standing = "Certificate of Good Standing"
    # common - incumbency_certificate_resolutions_proof_of_authority
    # common - ucc_tax_bankruptcy_judgment_and_pending_litigation_searches
    ...
    # common - articles_of_organization
    # common - employer_identification_number_w9_or_irs_letter
    original_operating_agreement_including_all_amendments = "Original Operating Agreement Including All Amendments"
    mipa_to_lessee_holdco_mmipa_master_tenant_mipa = "MIPA to Lessee HoldCo (MMIPA Master Tenant MIPA)"
    ...
    srec_contracts_or_proof_of_ability_to_merchandise = "SREC Contracts or Proof of Ability to Merchandise"
    production_based_incentive_pbi_approval = "Production Based Incentive (PBI) Approval"
    nyserda_grant = "NYSERDA Grant"
    nyserda_grant_status_portal_screen_shot_due_date = "NYSERDA Grant Status (Portal Screen Shot & Due Date)"
    ...
    ifc_issued_for_construction_stamped_project_drawings = "IFC (Issued for Construction) Stamped Project Drawings"
    project_schedule = "Project Schedule"
    current_progress_report_construction_complete = "Current Progress Report / Construction % Complete"
    epc_permit_studies_letter = "EPC Permit & Studies Letter"
    local_building_permits_electrical_construction_etc = "Local Building Permits (electrical, construction, etc.)"
    ...
    application_for_encroachment_driveway_access_permit = "Application for Encroachment / Driveway Access Permit"
    ...
    ofe_owner_furnished_equipment_proof_of_procurement = "OFE (Owner Furnished Equipment) Proof of Procurement"
    ...
    net_metering_interconnection_application = "Net Metering / Interconnection Application"
    ...
    interconnection_agreement_and_amendments = "Interconnection Agreement and Amendments"
    interconnection_25 = "Interconnection 25%"
    interconnection_75 = "Interconnection 75%"
    assignment_of_interconnection_agreement_and_amendments = "Assignment of Interconnection Agreement and Amendments"
    ...
    servicers_statement_of_qualifications_etc = "Servicer's Statement of Qualifications etc."
    # Insurance & Property Tax Stage-1
    property_tax_agreements = "Property Tax Agreements"
    epcs_insurance_liability_builders_risk = "EPC’s Insurance (Liability & Builders Risk)"
    real_estate_ownerslandlords_insurance_liability = "Real Estate Owner's/Landlord's Insurance (Liability)"
    ...
    projectcos_business_interruption_insurance = "Projectco's Business Interruption Insurance"
    insurance_companies_are_a_rated_or_better = "Insurance Companies are A rated or better"
    ...
    ucc_financing_statements_for_construction_loan = "UCC Financing Statements for Construction Loan"
    ...
    epc_mechanical_completion_reportcertificate = "EPC Mechanical Completion Report/Certificate"
    ...
    ucc_financing_statements_for_permanent_loan = "UCC Financing Statements for Permanent Loan"
    ...
    seller_acceptance_of_second_buyer_pv_syst_report = "Seller Acceptance of Second Buyer PV Syst Report"
    ...
    epc_substantial_completion_report_certificate = "EPC Substantial Completion Report/Certificate"
    # common - independent_engineer_report
    ...
    epc_final_completion_acceptance_report_certificate = "EPC Final Completion/Acceptance Report/Certificate"
    ...
    incumbency_certificate_resolutions_proof_of_authority = "Incumbency Certificate & Resolutions (Proof of Authority)"
    articles_of_organization = "Articles of Organization"
    employer_identification_number_w9_or_irs_letter = "Employer Identification Number (W-9 or IRS Letter)"
    ...
    operating_agreement_including_all_amendments = "Operating Agreement Including All Amendments"
    amended_restated_operating_agreement_post_tax_equity = "Operating Agreement, Amended & Restated (Post Tax Equity)"
