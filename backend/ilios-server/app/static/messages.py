...
class TelemetryMessages(BaseMessageEnum):
    ...
    site_mapping_update_success = "Site mapping has been updated"
    site_mapping_delete_success = "Site mapping has been deleted"
    site_mapping_already_exists = "Site mapping already exists"
    site_mapping_not_found = "Site mapping does not exist"
    device_mapping_create_success = "Device mapping has been created"
    device_mapping_update_success = "Device mapping has been updated"
    device_mapping_delete_success = "Device mapping has been deleted"
    device_mapping_already_exists = "Device mapping already exists"
    device_mapping_not_found = "Device mapping does not exist"
    bulk_device_mapping_success = "Bulk device mapping completed successfully"
