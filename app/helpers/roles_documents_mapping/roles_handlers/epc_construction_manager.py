...
from app.static.roles_documents_mapping.epc_construction_manager import (
...
class EPCConstructionManagerDocuments(RoleBasedDocumentConfig):

    def __init__(self):
        super().__init__(
            document_sub_sections_mapper=document_sub_sections_mapper,
            document_name_section_mapper=document_name_section_mapper,
            role_name=InternalRolesNames.epc_construction_manager,
        )
