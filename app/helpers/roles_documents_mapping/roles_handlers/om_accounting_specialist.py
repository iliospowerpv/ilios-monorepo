...
from app.static.roles_documents_mapping.om_accounting_specialist import (
    document_name_section_mapper,
    document_sub_sections_mapper,
)


class OMAccountingSpecialistDocuments(RoleBasedDocumentConfig):

    def __init__(self):
        super().__init__(
            document_sub_sections_mapper=document_sub_sections_mapper,
            document_name_section_mapper=document_name_section_mapper,
            role_name=InternalRolesNames.om_accounting_specialist,
        )
